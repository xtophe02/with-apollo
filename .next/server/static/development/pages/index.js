...
const HELLO = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a`
  query Hello {
    hello
  }
`;
...
const IndexPage = props => {
  const {
    data,
    loading
  } = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_3__["useQuery"])(HELLO); // console.log(data)

  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, loading ? __jsx("p", null, "loading...") : __jsx("p", null, data.hello));
};
...
module.exports = __webpack_require__(/*! /home/chrismo/Documents/PROJECTS/Nextjs/with-apollo/pages/index.js */"./pages/index.js");
